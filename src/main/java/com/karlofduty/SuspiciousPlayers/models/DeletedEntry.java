...
public class DeletedEntry extends PlayerEntry {
  ...
  public static final String INSERT =
      "INSERT INTO deleted_entries(deleted_time, deleter_uuid, archived_time, archiver_uuid, created_time, creator_uuid, suspicious_uuid, entry) VALUES (?,?,?,?,?,?,?,?)";
  public static final String SELECT = "SELECT * FROM deleted_entries WHERE id = ?;";
  public static final String SELECT_PLAYER =
      "SELECT * FROM deleted_entries WHERE suspicious_uuid = ? ORDER BY created_time LIMIT ?;";
